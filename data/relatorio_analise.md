...
**Categoria:** Excelente | **Recomendação:** `AUMENTE`
...
**Categoria:** Excelente | **Recomendação:** `MANTENHA`

P/L: 8.559211 | P/VP: 0.58903426 | DY: 573.00% | Utilities → Receita protegida + DY 573.0% com P/L razoável

---

#### ➡️ VALE3 — ◆ Score: 4.5

**Categoria:** Fraco | **Recomendação:** `MANTENHA`
...
**Categoria:** Bom | **Recomendação:** `MANTENHA`

Performance 1y: 14.57% | Índice: S&P 500 | AUM: N/D → ETF de renda variável para diversificação; hold para longo prazo
...
**Categoria:** Pouco Atrativo | **Recomendação:** `REDUZA`
...
**Categoria:** Muito Atrativo | **Recomendação:** `AUMENTE`
...
**Categoria:** Neutro | **Recomendação:** `REDUZA`
...
DY 12m: 15.42% | Selic: 14.40% | Taxa real: 10.01% → Renda fixa paga 14.4% com menos risco
...
DY 12m: 14.79% | Selic: 14.40% | Taxa real: 10.01% → Renda fixa paga 14.4% com menos risco
...
**Categoria:** Atrativo | **Recomendação:** `REDUZA`
...
### RENDA_FIXA_PRIVADA (5 ativo(s))

#### ➡️ CDB — ! Score: 3

**Categoria:** Pouco Atrativo | **Recomendação:** `MANTENHA`

Taxa contratada: 13.68% | CDI: 14.40% | Spread: -0.72pp → Taxa próxima a CDI: resgatar no vencimento e reaplicar
...
Tipo: Tesouro Prefixado | Rentabilidade travada → Travamento de taxa em ambiente incerto

---


### TESOURO_IPCA (2 ativo(s))

#### 📈 TESOURO — ⭐ Score: 9

**Categoria:** Excelente | **Recomendação:** `AUMENTE`

Tipo: Tesouro IPCA+ | Taxa real: 10.01% | IPCA 12m: 4.39% → Taxa real 10.01% excelente para lock-in de longo prazo
